...
export default function BookingSuccess({
  ...
  const duration =
    appointment.service_name === "HAIRCUT + MASSAGE"
      ? "45 mins"
      : appointment.service_name === "HAIR SPA" ||
          appointment.service_name === "DIAMOND FACIAL"
        ? "60 mins"
        : appointment.service_name === "GLOBAL HAIR COLOR" ||
            appointment.service_name === "HAIR DYE + DE-TAN" ||
            appointment.service_name === "PREMIUM GROOMING"
          ? "90 mins"
          : "30 mins";
